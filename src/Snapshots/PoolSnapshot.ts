...
export function createPoolSnapshot(
  ...
  return {
    ...
    tick: entity.tick,
    liquidityInRange: entity.liquidityInRange,
    stakedLiquidityInRange: entity.stakedLiquidityInRange,
    stakedReserve0: entity.stakedReserve0,
    stakedReserve1: entity.stakedReserve1,
